...
if (!isset($_SESSION['id']) ) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "SELECT * FROM posts WHERE user_id= '$user1_id' ORDER BY id DESC ";
        ...
        <body>
            <form  action="" method="post">
                ...
                <div class="row">
                  ...
                  <div class="col-50b">
                    <button type="button" onclick="window.location='http://local.test.com/myprofile.php'">MyProfile</button>
                  </div>
              </div>
